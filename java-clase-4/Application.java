public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("IncrementID: " + Usuario.getIncrementId());

        Estudiante est1 = new Estudiante("Nicolas", "2005-03-09", "asd@asd.com", "Java", "Ford Enter");
        Estudiante est2 = new Estudiante("Federico", "2004-09-23", "cvb@asd.com", "Java", "Ford Enter");
